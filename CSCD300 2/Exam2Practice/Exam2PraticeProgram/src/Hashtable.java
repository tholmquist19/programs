...
public class Hashtable {
	...
	*/
    ...
    public void put2(Object key, Object data){
        if(data == null || key == null)
            System.out.println("Error");
        if(this.contains(key))
            remove(key);
    ...
    public void put3(Object key, Object data){
        if(this.contains(key))
            remove(key);
        int pos = this.hash(key);
        if(this.table[pos] == null)
            this.table[pos] = new LinkedList<HashtableRecord>();
        LinkedLost<HashtableRecord> theList = (LinkedList<HashtableRecord>) this.table[pos];
        theList.add(new HashtableRecord(key, data));
        size++;
    }
    ...
    public Object get(Object key){
        ...
        if(this.table[pos] == null)
            return null;
        LinkedList<HashtableRecord> theList = (LinkedList<HashtableRecord>)this.table[pos];
        for(HashtableRecord r: theList)
            if(r.key == key || r.key.equals(key))
                return r.value;
        return null;
    }
    ...
    public Object get2(Object key){
        ...
        if(this.table[pos] == null)
            return null;
        LinkedList<Hashtablerecor> theList = (LinkedList<HashtableRecord>)this.table[pos];
        for(HashtableRecord r: theList)
            if(r.key == key || r.key.equals(key))
                return r.value;
        return null
